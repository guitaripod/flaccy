...
enum ScreenshotSeeder {
    ...
    static let catalog: [DemoAlbum] = [
        ...
        DemoAlbum(artist: heroArtist, title: "Field Lines", year: "2021", genre: "Progressive",
                  bitDepth: 24, sampleRate: 96000, top: rgb(0x1B2E46), bottom: rgb(0x090E16), accent: rgb(0x7FA6FF), motif: 2,
                  tracks: [track(1, "Field Lines", 298, loved: true), track(2, "Magnet School", 331), track(3, "Solenoid", 276),
                           track(4, "Night Arithmetic", 402), track(5, "Iron Filings", 254)]),
        DemoAlbum(artist: "Kestrel Vale", title: "Overwinter", year: "2021", genre: "Ambient",
                  bitDepth: 24, sampleRate: 48000, top: rgb(0x123640), bottom: rgb(0x05131A), accent: rgb(0x74D8E6), motif: 4,
                  tracks: [track(1, "Overwinter", 344, loved: true), track(2, "Firn", 289), track(3, "Snowline", 372),
                           track(4, "Polar Low", 231)]),
        DemoAlbum(artist: "Marisol Vane", title: "Velvet Arithmetic", year: "2023", genre: "Soul",
                  bitDepth: 24, sampleRate: 48000, top: rgb(0x3E1230), bottom: rgb(0x12050D), accent: rgb(0xFF9EC4), motif: 5,
                  tracks: [track(1, "Velvet Arithmetic", 263, loved: true), track(2, "Two of Cups", 241), track(3, "Slow Divide", 288),
                           track(4, "Gold Leaf", 274), track(5, "Small Hours", 302)]),
        DemoAlbum(artist: "Novaeu", title: "Statuary", year: "2024", genre: "Indie",
                  bitDepth: 16, sampleRate: 44100, top: rgb(0x40320F), bottom: rgb(0x140F05), accent: rgb(0xF2C25A), motif: 1,
                  tracks: [track(1, "Statuary", 219), track(2, "Colonnade", 234, loved: true), track(3, "Fold", 208),
                           track(4, "Plinth", 245), track(5, "Origami Streets", 226)]),
        DemoAlbum(artist: "The Hollowmen", title: "Vantablack Sun", year: "2024", genre: "Post-Rock",
                  bitDepth: 24, sampleRate: 96000, top: rgb(0x172224), bottom: rgb(0x070B0C), accent: rgb(0x86D9C6), motif: 3,
                  tracks: [track(1, "Vantablack Sun", 421, loved: true), track(2, "Afterimage", 353), track(3, "Heliopause", 398),
                           track(4, "Penumbra", 312)]),
        DemoAlbum(artist: "Halden Reef", title: "Tidal Glass", year: "2023", genre: "Ambient",
        ...
        DemoAlbum(artist: "Ptolemy Sound", title: "Almagest", year: "2024", genre: "Electronic",
                  bitDepth: 24, sampleRate: 48000, top: rgb(0x151E5A), bottom: rgb(0x060916), accent: rgb(0x6E9BFF), motif: 2,
                  tracks: [track(1, "Almagest", 312, loved: true), track(2, "Epicycle", 287), track(3, "Retrograde", 264),
                           track(4, "Deferent", 331), track(5, "Zenith", 248)]),
        DemoAlbum(artist: "Aster Bloom", title: "Greenhouse Hymns", year: "2023", genre: "Dream Pop",
                  bitDepth: 24, sampleRate: 48000, top: rgb(0x2A1748), bottom: rgb(0x0A0517), accent: rgb(0xCF9CFF), motif: 6,
                  tracks: [track(1, "Greenhouse Hymns", 251, loved: true), track(2, "Peony", 268), track(3, "Terrarium", 239),
                           track(4, "Chlorophyll", 292), track(5, "Slow Bloom", 244)]),
        DemoAlbum(artist: "Bright Antares", title: "Southern Cross", year: "2021", genre: "Jazz",
                  bitDepth: 24, sampleRate: 96000, top: rgb(0x103628), bottom: rgb(0x05120C), accent: rgb(0x93E6B6), motif: 0,
                  tracks: [track(1, "Southern Cross", 372, loved: true), track(2, "Coalsack", 314), track(3, "Acrux", 398),
                           track(4, "Meridian", 341)]),
        DemoAlbum(artist: "Odessa Grey", title: "Saltwater Gospel", year: "2022", genre: "Soul",
                  bitDepth: 16, sampleRate: 44100, top: rgb(0x431A28), bottom: rgb(0x13070B), accent: rgb(0xFF93A8), motif: 5,
                  tracks: [track(1, "Saltwater Gospel", 274, loved: true), track(2, "Brine", 248), track(3, "Harbor Lantern", 291),
                           track(4, "Undertow Choir", 263), track(5, "Low Country", 236)]),
        DemoAlbum(artist: "Cobalt Fields", title: "Nightglow", year: "2020", genre: "Electronic",
                  bitDepth: 24, sampleRate: 48000, top: rgb(0x101E52), bottom: rgb(0x05091A), accent: rgb(0x5AA0FF), motif: 2,
                  tracks: [track(1, "Nightglow", 298), track(2, "Phosphor", 271, loved: true), track(3, "Halogen", 254),
                           track(4, "Sodium Lamp", 319)]),
        DemoAlbum(artist: "Fenwick Lyle", title: "Radio Silence", year: "2023", genre: "Indie",
                  bitDepth: 16, sampleRate: 44100, top: rgb(0x3C2A12), bottom: rgb(0x120C05), accent: rgb(0xF0BE63), motif: 1,
                  tracks: [track(1, "Radio Silence", 227, loved: true), track(2, "Shortwave", 241), track(3, "Dead Air", 213),
                           track(4, "Carrier Tone", 258), track(5, "Static Bloom", 234)]),
        DemoAlbum(artist: "Selkie", title: "Longshore Drift", year: "2024", genre: "Folk",
