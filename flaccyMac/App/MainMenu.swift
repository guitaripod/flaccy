...
enum MainMenu {
    ...
    private static func appMenuItem() -> NSMenuItem {
        ...
        menu.addItem(withTitle: String(localized: "About Flaccy"), action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Settings…"), action: #selector(MacAppDelegate.showSettings(_:)), keyEquivalent: ",")
        menu.addItem(.separator())
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Hide Flaccy"), action: #selector(NSApplication.hide(_:)), keyEquivalent: "h")
        let hideOthers = menu.addItem(withTitle: String(localized: "Hide Others"), action: #selector(NSApplication.hideOtherApplications(_:)), keyEquivalent: "h")
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Quit Flaccy"), action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
    ...
    private static func fileMenuItem() -> NSMenuItem {
        ...
        let choose = menu.addItem(
            withTitle: String(localized: "Choose Music Folder…"),
            action: #selector(MacAppDelegate.chooseMusicFolder(_:)),
            keyEquivalent: "O"
        )
        choose.keyEquivalentModifierMask = [.command, .shift]
        menu.addItem(withTitle: String(localized: "Import Files…"), action: #selector(MacAppDelegate.importFiles(_:)), keyEquivalent: "o")
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Show Library in Finder"), action: #selector(MacAppDelegate.revealLibraryFolder(_:)), keyEquivalent: "")
        menu.addItem(withTitle: String(localized: "Clean Up Library…"), action: #selector(MacAppDelegate.cleanUpLibrary(_:)), keyEquivalent: "")
        menu.addItem(.separator())
    ...
    private static func editMenuItem() -> NSMenuItem {
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Find"), action: #selector(MacAppDelegate.focusSearch(_:)), keyEquivalent: "f")
        return submenuItem(menu)
    }

    private static func playbackMenuItem() -> NSMenuItem {
        let menu = NSMenu(title: String(localized: "Playback"))
        menu.addItem(withTitle: String(localized: "Play/Pause"), action: #selector(MacAppDelegate.togglePlayPause(_:)), keyEquivalent: "")
        let next = menu.addItem(withTitle: String(localized: "Next Track"), action: #selector(MacAppDelegate.nextTrack(_:)), keyEquivalent: rightArrowKey)
        next.keyEquivalentModifierMask = [.command]
        let previous = menu.addItem(withTitle: String(localized: "Previous Track"), action: #selector(MacAppDelegate.previousTrack(_:)), keyEquivalent: leftArrowKey)
        previous.keyEquivalentModifierMask = [.command]
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Toggle Shuffle"), action: #selector(MacAppDelegate.toggleShuffle(_:)), keyEquivalent: "")
        menu.addItem(withTitle: String(localized: "Cycle Repeat Mode"), action: #selector(MacAppDelegate.cycleRepeatMode(_:)), keyEquivalent: "")
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Love Track"), action: #selector(MacAppDelegate.toggleLove(_:)), keyEquivalent: "l")
        menu.addItem(.separator())
        let volumeUp = menu.addItem(withTitle: String(localized: "Increase Volume"), action: #selector(MacAppDelegate.increaseVolume(_:)), keyEquivalent: upArrowKey)
        volumeUp.keyEquivalentModifierMask = [.command]
        let volumeDown = menu.addItem(withTitle: String(localized: "Decrease Volume"), action: #selector(MacAppDelegate.decreaseVolume(_:)), keyEquivalent: downArrowKey)
    ...
    private static func viewMenuItem() -> NSMenuItem {
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Toggle Queue"), action: #selector(MacAppDelegate.toggleQueue(_:)), keyEquivalent: "k")
        let lyrics = menu.addItem(withTitle: String(localized: "Toggle Lyrics"), action: #selector(MacAppDelegate.toggleLyrics(_:)), keyEquivalent: "L")
    ...
    private static func windowMenuItem() -> NSMenuItem {
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: String(localized: "Bring All to Front"), action: #selector(NSApplication.arrangeInFront(_:)), keyEquivalent: "")
    ...
    private static func helpMenuItem() -> NSMenuItem {
        ...
        menu.addItem(withTitle: String(localized: "Flaccy Help"), action: #selector(NSApplication.showHelp(_:)), keyEquivalent: "?")
        NSApp.helpMenu = menu
        return submenuItem(menu)
    }
